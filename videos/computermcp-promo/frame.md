...
colors:
  ...
  text-muted: "#58A6FF"
  text-light: "#656565"
  accent-light: "rgba(63, 185, 80, 0.08)"
  accent-medium: "rgba(63, 185, 80, 0.15)"
  border: "rgba(63, 185, 80, 0.2)"
  card-bg: "rgba(63, 185, 80, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  h4-eyebrow:{ fontFamily: "-apple-system", cqw: 0.8, weight: 650, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "-apple-system", px: 12, weight: 400, color: "primary" }
  counter: { fontFamily: "-apple-system", px: 13, weight: 400, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (-apple-system, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "-apple-system", cqw: 1.25, weight: 400, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "-apple-system", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "-apple-system", cqw: 2.4, weight: 400, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "-apple-system", cqw: 2.6, weight: 650, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
...
- **Weights** — the brand font ships `{400, 650, 700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
