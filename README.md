...
> **The repo is ahead of npm.** This source exposes **25 tools, 11 of them
...
**Touch:** `computer_launch` · `computer_quit` · `computer_paste` · `computer_window` · `computer_menu` · `computer_press` · `computer_set_value` · `computer_ask_user` ·
