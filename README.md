...
> **The repo is ahead of npm.** This source exposes **23 tools, 11 of them
...
**Touch:** `computer_paste` · `computer_window` · `computer_menu` · `computer_press` · `computer_set_value` · `computer_ask_user` ·
